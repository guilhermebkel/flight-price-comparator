...
const ViajaNet = async (dataIda, dataVolta) => {      
        ...
        await page.goto(`https://www.viajanet.com.br/busca/passagens/voos#/BHZ/VIX/RT/${dataIda[0]}-${dataIda[1]}-${dataIda[2]}/${dataVolta[0]}-${dataVolta[1]}-${dataVolta[2]}/-/-/-/1/0/0/-/-/-/-`, {timeout: 1000000});
        ...
        return {
            ...
            Price: `${price}`, 
            Url: `https://www.viajanet.com.br/busca/passagens/voos#/BHZ/VIX/RT/${dataIda[0]}-${dataIda[1]}-${dataIda[2]}/${dataVolta[0]}-${dataVolta[1]}-${dataVolta[2]}/-/-/-/1/0/0/-/-/-/-`,
            LastUpdate: `${new Date()}`      
        };
};

const Milhas = async (dataIda, dataVolta) => {
        //const browser = await puppeteer.launch({executablePath: 'chromium-browser'});
        ...
        await page.goto(`https://123milhas.com/v2/busca?de=BHZ&para=VIX&ida=${dataIda[0]}-${dataIda[1]}-${dataIda[2]}&volta=${dataVolta[0]}-${dataVolta[1]}-${dataVolta[2]}&adultos=1&criancas=0&search_id=164021478`, {timeout: 1000000});
        ...
        return {
            ...
            ReturnDate: `${dataVolta[0]}/${dataVolta[1]}/${dataVolta[2]}`,
            Price: `${price}`,  
            Url: `https://123milhas.com/v2/busca?de=BHZ&para=VIX&ida=${dataIda[0]}-${dataIda[1]}-${dataIda[2]}&volta=${dataVolta[0]}-${dataVolta[1]}-${dataVolta[2]}&adultos=1&criancas=0&search_id=164021478`,
            LastUpdate: `${new Date()}`
        };
};

const PassagensPromo = async (dataIda, dataVolta) => {
        //const browser = await puppeteer.launch({executablePath: 'chromium-browser'});
        ...
        await page.goto(`https://www.passagenspromo.com.br/site/aereo/pesquisa/BHZ/VIX/${dataIda[0]}-${dataIda[1]}-${dataIda[2]}/${dataVolta[0]}-${dataVolta[1]}-${dataVolta[2]}/1/0/0`, {timeout: 1000000});
        ...
        return {
            ...
            ReturnDate: `${dataVolta[0]}/${dataVolta[1]}/${dataVolta[2]}`,
            Price: `${price}`,   
            Url: `https://www.passagenspromo.com.br/site/aereo/pesquisa/BHZ/VIX/${dataIda[0]}-${dataIda[1]}-${dataIda[2]}/${dataVolta[0]}-${dataVolta[1]}-${dataVolta[2]}/1/0/0`,
            LastUpdate: `${new Date()}`
        };
};

const Voopter = async (dataIda, dataVolta) => {
        //const browser = await puppeteer.launch({executablePath: 'chromium-browser'});
        ...
        await page.goto(`https://voopter.com.br/passagens-aereas-de-belo-horizonte/BHZ/para-vitoria/VIX#dl%5B%5D=${dataIda[2]}${dataIda[1]}${dataIda[0]}&dr%5B%5D=${dataVolta[2]}${dataVolta[1]}${dataVolta[0]}&na=1&nc=0&ni=0&sn=true&pop=true`, {timeout: 1000000});
        ...
        return {
            ...
            ReturnDate: `${dataVolta[0]}/${dataVolta[1]}/${dataVolta[2]}`,
            Price: `${price}`,   
            Url: `https://voopter.com.br/passagens-aereas-de-belo-horizonte/BHZ/para-vitoria/VIX#dl%5B%5D=${dataIda[2]}${dataIda[1]}${dataIda[0]}&dr%5B%5D=${dataVolta[2]}${dataVolta[1]}${dataVolta[0]}&na=1&nc=0&ni=0&sn=true&pop=true`,
            LastUpdate: `${new Date()}`
        };
};
